							...
							<template v-for="comment in task.comments">
								<div class="comment-container" :key="comment.id">
									<div class="comment-creator">
										<div class="member">
											<avatar :size="30" :username="comment.byMember.fullname" :title="`${comment.byMember.fullname}`" />
										</div>
									</div>
									...
									<div class="activity-container" :key="activity.id">
										<div class="activity">
											<div class="activity-creator">
												<div class="member">
													<avatar :size="30" :username="activity.byMember.fullname" :title="`${activity.byMember.fullname}`" />
												</div>
											</div>
