            ...
            <div class="task-detail clearfix">
               ...
               <div class="window-main-col no-box-sizing">
                  <div class="task-detail-data clearfix">
                     ...
                     <div v-if="task.members.length" class="task-detail-item clearfix">
                        ...
                        <div v-if="task.members && task.members.length" class="task-detail-members-list">
                           <a class="member task-detail-member" v-for="member in task.members" :key="member._id" @click="toggleMiniProfile($event, member)">
                        ...
                        <mini-profile v-if="profileOfUser" :isMiniProfileOpen="isMiniProfileOpen" :modalPos="modalPos" :user="profileOfUser" @closeMiniProfile="closeMiniProfile" @removeTaskMember="removeTaskMember" />
                     </div>
                        ...
                        <div class="add-desc-area">
                           <div class="desc">
                              <div class="desc-content">
                                 ...
                                 <p class="u-bottom">
                                    <a @click="toggleEdit" v-show="!taskDesc && !isEditing" class="description-fake-text-area no-box-sizing" href="#"> Add a more detailed description… </a>
                                 </p>
                              </div>
                  ...
                  <div class="new-comment-section">
                     <div class="member">
                        <avatar :src="loggedInUser.imgUrl" :size="30" :username="loggedInUser.fullname" :title="`${loggedInUser.fullname}(${loggedInUser.username})`" />
                     </div>
                     <form>
                        <div class="comment-frame" :class="{ focused: isCommenting }">
                           <div class="comment-box" :class="{ focused: isCommenting }">
                              <textarea-autosize class="comment-box-input" @click.native="isCommenting = true" :class="{ focused: isCommenting }" rows="1" v-model="newCommentTxt" aria-label="Write a comment" placeholder="Write a comment…" dir="auto"> </textarea-autosize>
                              <div
                                 v-show="isCommenting"
                           ...
                           <div class="activity-container" :key="activity.id">
                              <div class="activity">
                                 <div class="activity-creator">
                                    <div class="member">
                                       <avatar :src="loggedInUser.imgUrl" :size="30" :username="activity.byMember.fullname" :title="`${activity.byMember.fullname}`" />
                                    </div>
                                 </div>
