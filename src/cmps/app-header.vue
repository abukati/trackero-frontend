               ...
               <template v-else>
                  <div class="more-opts-btn-container">
                     <button @click.stop="modalOpen" data-cmp="More" class="nav-link-btn nav-item" :class="{ 'modal-active': isModalOpen && modalCmp.type === 'More' }">
                        ...
                        <span data-cmp="More" class="btn-icon-container">
                           <span class="modal-icon">
                              <svg @click.stop="modalOpen" width="24px" height="24px" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                 <path fill-rule="evenodd" clip-rule="evenodd" d="M18.5303 9.46967C18.8232 9.76256 18.8232 10.2374 18.5303 10.5303L12.5303 16.5303C12.2374 16.8232 11.7626 16.8232 11.4697 16.5303L5.46967 10.5303C5.17678 10.2374 5.17678 9.76256 5.46967 9.46967C5.76256 9.17678 6.23744 9.17678 6.53033 9.46967L12 14.9393L17.4697 9.46967C17.7626 9.17678 18.2374 9.17678 18.5303 9.46967Z" fill="currentColor" />
                              </svg>
                           </span>
                        </span>
                  ...
                  <div class="nav-board-create nav-small-more-opts">
                     <a @click.stop="modalOpen" data-cmp="Create" class="nav-item" :class="{ 'modal-active': isModalOpen && modalCmp.type === 'Create' }">
                        <span data-cmp="More" class="btn-icon-container">
                           <span class="modal-icon">
                              <svg @click.stop="modalOpen" width="24" height="24" role="presentation" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
         ...
         <div class="nav-reactive-links">
            ...
            <router-link class="user-profile-btn" to="/user">
               <div class="user-avatar-container">
                  <avatar class="user-avatar" :src="imgSrc" :username="loggedUser.fullname" :title="`${loggedUser.fullname}(${loggedUser.username})`" :size="32"></avatar>
               </div>
            </router-link>
         </div>
      </nav>
