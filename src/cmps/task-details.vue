         ...
         <div class="window-wrapper">
            ...
            <div class="task-detail clearfix">
               ...
               <div class="window-main-col no-box-sizing">
                  <div class="task-detail-data clearfix">
                     ...
                     <div
                        ...
                        class="task-detail-item clearfix"
                     >
                     ...
                     >
                        ...
                        <div
                           ...
                           class="task-detail-labels-list"
                        >
                           <span
                              v-for="label in task.labels"
                              :key="label.id"
                              class="card-label task-detail-label"
                     ...
                     <div class="task-detail-item hide">
                        ...
                        <div
                           class="task-detail-badge task-detail-last-updated"
                        ></div>
                     </div>
                  </div>
                              ...
                              <template v-for="attachment in task.attachments">
                                 ...
                                 >
                                    ...
                                    <p class="attachment-thumbnail-details">
                                       <span
                                          class="attachment-thumbnail-name"
                                       ...
                                       <span
                                          class="
                                             attachment-thumbnail-details-options
                                          "
                                       >
                                          <span
                                             class="icon-sm icon-card-cover"
                                          ></span>
                                          <span
                                             v-show="
                                                task.style.url !==
               ...
               <div class="window-sidebar no-box-sizing">
                  ...
                  <div
                     v-if="!showSuggested"
                     class="window-module suggested-actions-module"
                  >
                  ...
                  <div class="window-module clearfix">
                     ...
                     <div>
                        ...
                        <a
                           @click="toggleListCmp($event, 'check-list')"
                           class="button-link"
                           title="Checklist"
                        >
                        ...
                        <a
                           @click="toggleListCmp($event, 'attachment-list')"
                           class="button-link"
                           title="Attachment"
                        >
