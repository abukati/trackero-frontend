            ...
            <div>
               <div class="pop-over-section">
                  ...
                  <div class="board-members">
                     <ul
                        v-if="membersToDisplay.length"
                        class="pop-over-member-list"
                     >
                        <h4>Board members</h4>
                        <li
                           class="member-item"
                        ...
                        >
                           <a @click="toggleMember(member)" class="name">
                              ...
                              <span
                                 :class="isMember(member._id)"
                                 class="checked-icon icon-sm"
                              ></span>
                           </a>
                        </li>
                     </ul>
                     <span v-else class="empty empty-error"
                        >Looks like that person isn't a member yet. Enter their
                        email address to add them to the card and board.</span
                     >
                  </div>
               </div>
            </div>
