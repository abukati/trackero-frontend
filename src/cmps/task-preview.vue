<template>
   ...
   <router-link class="list-card" :to="`/board/${board._id}/${group.id}/${task.id}`">
      ...
      <!-- pencil-edit -->
      <div v-if="!isCoverBgc" @click.prevent="openPreviewEdit($event)" class="list-card-edit-pencil">
      ...
      <div class="list-card-details">
         <div v-if="task.labels && task.labels.length" class="list-card-labels">
            ...
            <label for="label-toggler" class="label-toggler" @click.self.prevent="toggle">
               <span v-for="label in task.labels" :key="label.id" class="card-label" :style="{ backgroundColor: label.color }">
