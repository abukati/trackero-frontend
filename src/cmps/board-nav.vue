         ...
         >
            <span class="icon-overflow-menu board-header-btn-icon">
               ...
               >
                  ...
                  <path
                     style="fill: currentColor"
                     d="M51.2,295.2C23.2,295.2,0,272,0,244"
                  />
                  <g>
                     <path
                        style="fill: currentColor"
                        d="M102.4,244c0,28-23.2,51.2-51.2,51.2"
                     />
                     <path
                        style="fill: currentColor"
                        d="M15.2,208c20-20,52-20,72,0s20,52,0,72"
                     />
                  </g>
                  <circle
                     style="fill: currentColor"
                  ...
                  <path
                     style="fill: currentColor"
                     d="M244,295.2c-28,0-51.2-23.2-51.2-51.2"
                  />
                  <g>
                     <path
                        style="fill: currentColor"
                        d="M295.2,244c0,28-23.2,51.2-51.2,51.2"
                     />
                     <path
                        style="fill: currentColor"
                        d="M208,208c20-20,52-20,72,0s20,52,0,72"
                     />
                  </g>
                  <circle
                     style="fill: currentColor"
                  ...
                  <path
                     style="fill: currentColor"
                     d="M436.8,295.2c-28,0-51.2-23.2-51.2-51.2"
                  />
                  <g>
                     <path
                        style="fill: currentColor"
                        d="M488,244c0,28-23.2,51.2-51.2,51.2"
                     />
                     <path
                        style="fill: currentColor"
                        d="M400.8,208c20-20,52-20,72,0s20,52,0,72"
                     />
                  </g>
               </svg>
            </span>
