<template>
	<div class="board-nav clearfix">
		...
		<div class="board-header-btn-org-wrapper">
			...
			<a  id="permission-level" class="board-header-btn perms-btn change-vis" title="All members of the Workspace can see and edit this board">
				<span class="board-header-btn-icon icon-sm icon-organization-visible">
					<svg width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" stroke="currentColor" fill="currentColor" d="M3.5 8a5.5 5.5 0 118.596 4.547 9.005 9.005 0 015.9 8.18.75.75 0 01-1.5.045 7.5 7.5 0 00-14.993 0 .75.75 0 01-1.499-.044 9.005 9.005 0 015.9-8.181A5.494 5.494 0 013.5 8zM9 4a4 4 0 100 8 4 4 0 000-8z"/><path stroke="currentColor" fill="currentColor" d="M17.29 8c-.148 0-.292.01-.434.03a.75.75 0 11-.212-1.484 4.53 4.53 0 013.38 8.097 6.69 6.69 0 013.956 6.107.75.75 0 01-1.5 0 5.193 5.193 0 00-3.696-4.972l-.534-.16v-1.676l.41-.209A3.03 3.03 0 0017.29 8z"/></svg>
				</span>
		...
		<div class="board-header-btns mod-left">
			<draggable class="board-header-facepile board-member-list" v-model="memberList" 
				group="memberList" draggable=".member-draggable">
		...
		<div class="board-header-btns mod-right">
			...
			<a  class="board-header-btn mod-show-menu show-sidebar">
				<span class="icon-overflow-menu board-header-btn-icon">
					<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 488 488" style="enable-background:new 0 0 488 488;" xml:space="preserve"><circle style="fill:currentColor;" cx="51.2" cy="244" r="51.2"/><path style="fill:currentColor;" d="M51.2,295.2C23.2,295.2,0,272,0,244"/><g><path style="fill:currentColor;" d="M102.4,244c0,28-23.2,51.2-51.2,51.2"/><path style="fill:currentColor;" d="M15.2,208c20-20,52-20,72,0s20,52,0,72"/></g><circle style="fill:currentColor;" cx="244" cy="244" r="51.2"/><path style="fill:currentColor;" d="M244,295.2c-28,0-51.2-23.2-51.2-51.2"/><g><path style="fill:currentColor;" d="M295.2,244c0,28-23.2,51.2-51.2,51.2"/><path style="fill:currentColor;" d="M208,208c20-20,52-20,72,0s20,52,0,72"/></g><circle style="fill:currentColor;" cx="436.8" cy="244" r="51.2"/><path style="fill:currentColor;" d="M436.8,295.2c-28,0-51.2-23.2-51.2-51.2"/><g><path style="fill:currentColor;" d="M488,244c0,28-23.2,51.2-51.2,51.2"/><path style="fill:currentColor;" d="M400.8,208c20-20,52-20,72,0s20,52,0,72"/></g></svg>
				</span>
