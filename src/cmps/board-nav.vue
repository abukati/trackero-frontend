   ...
   <div class="board-nav clearfix">
            ...
            <span class="board-views-icon-container">
               <span class="board-views-icon">
                  <svg width="24" height="24" role="presentation" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                     <path fill-rule="evenodd" clip-rule="evenodd" d="M2 7V15C2 16.1046 2.89543 17 4 17H6C7.10457 17 8 16.1046 8 15V7C8 5.89543 7.10457 5 6 5H4C2.89543 5 2 5.89543 2 7ZM4 7V15H6V7L4 7Z" fill="#fff"></path>
                     <path fill-rule="evenodd" clip-rule="evenodd" d="M9 7V13C9 14.1046 9.89543 15 11 15H13C14.1046 15 15 14.1046 15 13V7C15 5.89543 14.1046 5 13 5H11C9.89543 5 9 5.89543 9 7ZM11 7V13H13V7L11 7Z" fill="#fff"></path>
                     <path fill-rule="evenodd" clip-rule="evenodd" d="M16 17V7C16 5.89543 16.8954 5 18 5H20C21.1046 5 22 5.89543 22 7V17C22 18.1046 21.1046 19 20 19H18C16.8954 19 16 18.1046 16 17ZM18 17V7L20 7V17H18Z" fill="#fff"></path>
                  </svg>
               </span>
            </span>
      ...
      <a @click="toggleBoardStar" class="board-header-btn board-header-star-container" title="Click to star or unstar this board. Starred board show up at the top of your boards list">
         <span class="icon-star board-header-btn-icon" :class="{ 'icon-starred': isBoardStarred }">
            <svg v-if="isBoardStarred" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 55.867 55.867" style="enable-background: new 0 0 55.867 55.867" xml:space="preserve">
            ...
            <svg v-else version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 243.317 243.317" style="enable-background: new 0 0 243.317 243.317" xml:space="preserve">
      ...
      <div class="board-header-btns mod-left">
         <draggable class="board-header-facepile board-member-list" v-model="memberList" group="memberList" draggable=".member-draggable" >
